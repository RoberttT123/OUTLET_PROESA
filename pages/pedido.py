...
# ==============================================================================
    ...
    def render_pedido():
        ...
        # Se ve igual que st.tabs, funciona horizontal en mobile,
        # y su índice se controla via session_state antes de cada rerun.
        tab_sel = st.radio(
            "tabs_nav",
            opciones,
                            ...
                            if not bloqueado:
                                ...
                                with c_btn:
                                    if st.button("➕ Solicitar", key=f"add_{codigo}", use_container_width=True):
                                        ...
                                        # Quedarse en catálogo tras agregar
    ...
    # ──────────────────────────────────────────────────────────────────────────
    # ENVÍO DEL PEDIDO (fuera del fragment para st.rerun() global)
    # ──────────────────────────────────────────────────────────────────────────
    def enviar_pedido():
        if not st.session_state.carrito:
